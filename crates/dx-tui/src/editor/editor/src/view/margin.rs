...
impl LineIndicator {
	...
	pub fn with_marker(
		...
		Self { symbol: symbol.into(), color, priority, marker_id }
	}
}
...
impl MarginContent {
	...
	pub fn symbol(text: impl Into<String>, style: Style) -> Self {
		Self::Symbol { text: text.into(), style }
	}

	/// Create a colored symbol
	pub fn colored_symbol(text: impl Into<String>, color: Color) -> Self {
		Self::Symbol { text: text.into(), style: Style::default().fg(color) }
	}
...
impl MarginAnnotation {
	...
	pub fn new(line: usize, position: MarginPosition, content: MarginContent) -> Self {
		Self { line, position, content, id: None }
	}
	...
	pub fn with_id(
		...
		Self { line, position, content, id: Some(id) }
	}
	...
	pub fn breakpoint(line: usize) -> Self {
		Self::new(line, MarginPosition::Left, MarginContent::colored_symbol("●", Color::Red))
	}
	...
	pub fn warning(line: usize) -> Self {
		Self::new(line, MarginPosition::Left, MarginContent::colored_symbol("⚠", Color::Yellow))
	}

	/// Helper: Create an info indicator
	pub fn info(line: usize) -> Self {
		Self::new(line, MarginPosition::Left, MarginContent::colored_symbol("ℹ", Color::Blue))
	}
}
...
impl MarginManager {
	...
	pub fn set_line_indicator(
		...
		self.line_indicators.entry(marker_id.0).or_default().insert(namespace, indicator);
	...
	pub fn add_annotation(&mut self, annotation: MarginAnnotation) {
		...
		annotations.entry(annotation.line).or_insert_with(Vec::new).push(annotation);
	}
