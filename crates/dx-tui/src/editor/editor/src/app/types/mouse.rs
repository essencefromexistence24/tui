...
pub struct MouseState {
	...
	/// Whether we're currently dragging the file explorer scrollbar
	pub dragging_file_explorer_scrollbar: bool,
	/// Initial scroll offset when file explorer scrollbar drag started
	pub drag_start_file_explorer_scroll: Option<usize>,
