//! Terminal emulation service for Dx
//!
...
//!
//! Located at `~/.local/share/dx/terminals/{workdir}/fresh-terminal-{id}.txt`:
//!
...
pub use manager::{TerminalId, TerminalManager, detect_shell};
