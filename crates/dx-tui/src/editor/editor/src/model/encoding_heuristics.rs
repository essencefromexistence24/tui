...
mod tests {
	...
	fn test_pure_ascii() {
		...
		assert!(!has_windows1250_pattern(ascii), "Pure ASCII should not trigger Windows-1250");
	}
	...
	fn test_windows1252_french() {
		...
		assert!(!has_windows1250_pattern(&french), "French text should not trigger Windows-1250");
	}
	...
	fn test_windows1251_upper_and_lower() {
		...
		assert!(has_windows1251_pattern(privet), "Cyrillic upper + lower should trigger Windows-1251");
	}
	...
	fn test_windows1251_sentence_with_spaces() {
		...
		assert!(has_windows1251_pattern(hello_world), "Russian sentence should trigger Windows-1251");
	}
	...
	fn test_not_windows1251_french() {
		...
		assert!(!has_windows1251_pattern(&french), "French text should not trigger Windows-1251");
	}

	#[test]
	fn test_not_windows1251_ascii() {
		let ascii = b"Hello, World!";
		assert!(!has_windows1251_pattern(ascii), "Pure ASCII should not trigger Windows-1251");
	}
	...
	fn test_not_windows1251_sharp_s_excluded() {
		...
		assert!(!has_windows1251_pattern(&german), "German ß should not trigger Windows-1251");
	}
