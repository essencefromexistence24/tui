...
mod tests {
	...
	fn test_path_backslash_separators() {
		...
		assert!(path_glob_matches("C:\\Users\\**\\rc.*", "C:\\Users\\etc\\rc.conf"));
		assert!(path_glob_matches("C:\\Users\\**\\rc.*", "C:\\Users\\etc\\init\\rc.local"));
		assert!(!path_glob_matches("C:\\Users\\**\\rc.*", "D:\\Users\\etc\\rc.conf"));
	}
	...
	fn test_path_backslash_single_star_no_crossing() {
		...
		assert!(path_glob_matches("C:\\etc\\*.conf", "C:\\etc\\nftables.conf"));
		assert!(!path_glob_matches("C:\\etc\\*.conf", "C:\\etc\\sub\\nftables.conf"));
	}
