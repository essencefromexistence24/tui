//! WASM module for running Dx editor in browsers
//!
...
impl WasmEditor {
	...
	pub fn with_content(content: &str) -> Self {
		...
		Self {
			...
			buffer: Buffer::from_str(content, crate::config::LARGE_FILE_THRESHOLD_BYTES as usize, fs),
		}
	}
