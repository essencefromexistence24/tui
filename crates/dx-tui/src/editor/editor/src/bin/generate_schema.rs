//! Generate JSON Schemas for Dx configuration and themes
//!
...
use dx::services::packages::PackageManifest;
use dx::view::theme::ThemeFile;
            ...
            if let Some(obj) = json.as_object_mut() {
                obj.insert(
                    ...
                    serde_json::Value::String(
                        "https://raw.githubusercontent.com/sinelaw/fresh/main/crates/dx-editor/plugins/schemas/package.schema.json".to_string()
                    ),
                );
            }
            json
