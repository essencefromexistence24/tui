...
use dx::input::commands::Suggestion;
use dx::input::keybindings::Action;
use dx::services::live_grep_state::{GrepMatch, LiveGrepLastState};
use dx::view::prompt::PromptType;
use std::fs;
...
fn test_open_terminal_in_dock_spans_full_width_with_existing_vsplit() {
    use dx::view::split::SplitNode;
    use dx_core::SplitDirection;
