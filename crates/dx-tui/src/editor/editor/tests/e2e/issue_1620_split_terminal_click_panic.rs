...
//!
//! ```text
//! thread 'main' panicked at crates/dx-editor/src/app/event_apply.rs:101:18:
...
//! `crates/dx-editor/src/app/buffer_close.rs:221-225` updates the
...
fn content_rect_for_buffer(
    ...
    buffer_id: model::event::BufferId,
) -> ratatui::layout::Rect {
