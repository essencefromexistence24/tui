//! Regression test for https://github.com/anomalyco/dx/issues/1722
//!
//! When a user runs Dx from a project directory that happens to contain
//! a folder called `plugins/` (unrelated to Dx's plugin system), the
