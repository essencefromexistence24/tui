...
//! transitively calls `i18n::init_with_config` whenever it
...
//! `config.locale`, or (b) directly calls `i18n::set_locale`,
...
/// by calling `i18n::set_locale` directly). The guard resets
