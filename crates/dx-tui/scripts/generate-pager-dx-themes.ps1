...
#
#   pwsh crates/dx-tui/scripts/generate-pager-dx-themes.ps1

$ErrorActionPreference = "Stop"

$root = git rev-parse --show-toplevel
$themesJson = Join-Path $root "crates/dx-tui/themes.json"
...
$body += "//! Regenerate with: pwsh crates/dx-tui/scripts/generate-pager-dx-themes.ps1"
