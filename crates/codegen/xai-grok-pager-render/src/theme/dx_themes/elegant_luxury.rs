//! DX theme: "Elegant Luxury" — auto-generated from dx-tui themes.json.
...
mod palette {
    ...
    pub const ACCENT: Color = rgb(158, 128, 115);
    pub const ACCENT_DIM: Color = rgb(95, 77, 69);
    pub const GREEN: Color = rgb(152, 178, 94);
    pub const RED: Color = rgb(218, 43, 38);
    pub const RED1: Color = rgb($[Math]::Min(255, 194), $[Math]::Min(255, 143), $[Math]::Min(255, 140));
    pub const YELLOW: Color = rgb(188, 128, 58);
    pub const CYAN: Color = rgb(155, 168, 172);
    pub const BLUE: Color = rgb(79, 64, 145);
    pub const MAGENTA: Color = rgb(198, 64, 155);
    pub const PURPLE: Color = rgb(178, 43, 135);
    pub const ORANGE: Color = rgb(168, 74, 38);
