//! DX theme: "Solar Dusk" — auto-generated from dx-tui themes.json.
...
mod palette {
    use super::*;
    pub const BG: Color = rgb(54, 52, 0);
    pub const BG_DARK: Color = rgb(50, 48, 0);
    pub const BG_STORM: Color = rgb(54, 52, 0);
    pub const BG_HIGHLIGHT: Color = rgb(70, 68, 16);
    pub const FG: Color = rgb(246, 246, 0);
    pub const FG_DARK: Color = rgb(197, 197, 0);
    pub const FG_GUTTER: Color = rgb(82, 82, 0);
    pub const COMMENT: Color = rgb(123, 123, 0);
    pub const DARK3: Color = rgb(98, 98, 0);
    pub const DARK5: Color = rgb(148, 148, 0);
    pub const ACCENT: Color = rgb(76, 87, 91);
    pub const ACCENT_DIM: Color = rgb(46, 52, 55);
    pub const GREEN: Color = rgb(120, 137, 74);
    pub const RED: Color = rgb(136, 29, 30);
    pub const RED1: Color = rgb($[Math]::Min(255, 178), $[Math]::Min(255, 126), $[Math]::Min(255, 123));
    pub const YELLOW: Color = rgb(106, 87, 46);
    pub const CYAN: Color = rgb(131, 127, 136);
    pub const BLUE: Color = rgb(38, 44, 121);
    pub const MAGENTA: Color = rgb(116, 44, 131);
    pub const PURPLE: Color = rgb(96, 29, 111);
    pub const ORANGE: Color = rgb(127, 54, 30);
...
impl Theme {
    pub const fn solar_dusk() -> Self {
        Self {
            ...
            code_fg: FG,
            code_border: COMMENT,
            code_highlight_bg: rgb(86, 84, 32),
