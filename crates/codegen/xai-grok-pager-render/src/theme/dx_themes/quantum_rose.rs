//! DX theme: "Quantum Rose" — auto-generated from dx-tui themes.json.
...
mod palette {
    use super::*;
    pub const BG: Color = rgb(47, 43, 0);
    pub const BG_DARK: Color = rgb(43, 39, 0);
    pub const BG_STORM: Color = rgb(47, 43, 0);
    pub const BG_HIGHLIGHT: Color = rgb(63, 59, 16);
    pub const FG: Color = rgb(230, 209, 0);
    pub const FG_DARK: Color = rgb(184, 167, 0);
    pub const FG_GUTTER: Color = rgb(77, 70, 0);
    pub const COMMENT: Color = rgb(115, 104, 0);
    pub const DARK3: Color = rgb(92, 84, 0);
    pub const DARK5: Color = rgb(138, 125, 0);
    pub const ACCENT: Color = rgb(96, 80, 96);
    pub const ACCENT_DIM: Color = rgb(58, 48, 58);
    pub const GREEN: Color = rgb(114, 130, 70);
    pub const RED: Color = rgb(156, 27, 32);
    pub const RED1: Color = rgb($[Math]::Min(255, 201), $[Math]::Min(255, 142), $[Math]::Min(255, 153));
    pub const YELLOW: Color = rgb(126, 80, 48);
    pub const CYAN: Color = rgb(136, 120, 144);
    pub const BLUE: Color = rgb(48, 40, 126);
    pub const MAGENTA: Color = rgb(136, 40, 136);
    pub const PURPLE: Color = rgb(116, 27, 116);
    pub const ORANGE: Color = rgb(120, 50, 32);
    pub const RED_DARK: Color = rgb(141, 14, 20);
    pub const GREEN_DARK: Color = rgb(6, 139, 6);
}
use palette::*;
...
impl Theme {
    pub const fn quantum_rose() -> Self {
        Self {
            ...
            code_fg: FG,
            code_border: COMMENT,
            code_highlight_bg: rgb(79, 75, 32),
