//! DX theme: "Pastel Dreams" — auto-generated from dx-tui themes.json.
...
mod palette {
    ...
    pub const FG: Color = rgb(232, 235, 0);
    pub const FG_DARK: Color = rgb(186, 188, 0);
    pub const FG_GUTTER: Color = rgb(77, 78, 0);
    pub const COMMENT: Color = rgb(116, 118, 0);
    pub const DARK3: Color = rgb(93, 94, 0);
    pub const DARK5: Color = rgb(139, 141, 0);
    pub const ACCENT: Color = rgb(93, 91, 98);
    pub const ACCENT_DIM: Color = rgb(56, 55, 59);
    pub const GREEN: Color = rgb(123, 141, 76);
    pub const RED: Color = rgb(153, 30, 33);
    pub const RED1: Color = rgb($[Math]::Min(255, 222), $[Math]::Min(255, 195), $[Math]::Min(255, 195));
    pub const YELLOW: Color = rgb(123, 91, 49);
    pub const CYAN: Color = rgb(138, 131, 147);
    pub const BLUE: Color = rgb(46, 46, 128);
    pub const MAGENTA: Color = rgb(133, 46, 138);
    pub const PURPLE: Color = rgb(113, 30, 118);
    pub const ORANGE: Color = rgb(131, 56, 33);
