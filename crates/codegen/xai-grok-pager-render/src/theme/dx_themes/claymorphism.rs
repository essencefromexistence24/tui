//! DX theme: "Claymorphism" — auto-generated from dx-tui themes.json.
...
mod palette {
    ...
    pub const ACCENT: Color = rgb(93, 92, 90);
    pub const ACCENT_DIM: Color = rgb(56, 55, 54);
    pub const GREEN: Color = rgb(124, 142, 76);
    pub const RED: Color = rgb(153, 31, 30);
    pub const RED1: Color = rgb($[Math]::Min(255, 194), $[Math]::Min(255, 143), $[Math]::Min(255, 140));
    pub const YELLOW: Color = rgb(123, 92, 45);
    pub const CYAN: Color = rgb(130, 132, 135);
    pub const BLUE: Color = rgb(46, 46, 120);
    pub const MAGENTA: Color = rgb(133, 46, 130);
    pub const PURPLE: Color = rgb(113, 31, 110);
    pub const ORANGE: Color = rgb(132, 56, 30);
