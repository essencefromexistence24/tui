//! DX theme: "Amber Minimal" — auto-generated from dx-tui themes.json.
...
mod palette {
    use super::*;
    pub const BG: Color = rgb(48, 48, 0);
    pub const BG_DARK: Color = rgb(44, 44, 0);
    pub const BG_STORM: Color = rgb(48, 48, 0);
    pub const BG_HIGHLIGHT: Color = rgb(64, 64, 16);
    ...
    pub const ACCENT: Color = rgb(131, 106, 97);
    pub const ACCENT_DIM: Color = rgb(79, 64, 58);
    pub const GREEN: Color = rgb(135, 156, 83);
    pub const RED: Color = rgb(191, 35, 32);
    pub const RED1: Color = rgb($[Math]::Min(255, 194), $[Math]::Min(255, 143), $[Math]::Min(255, 140));
    pub const YELLOW: Color = rgb(161, 106, 48);
    pub const CYAN: Color = rgb(137, 146, 146);
    pub const BLUE: Color = rgb(66, 53, 127);
    pub const MAGENTA: Color = rgb(171, 53, 137);
    pub const PURPLE: Color = rgb(151, 35, 117);
    pub const ORANGE: Color = rgb(146, 63, 32);
    pub const RED_DARK: Color = rgb(144, 14, 20);
    pub const GREEN_DARK: Color = rgb(6, 154, 6);
}
use palette::*;
...
impl Theme {
    pub const fn amber_minimal() -> Self {
        Self {
            ...
            code_fg: FG,
            code_border: COMMENT,
            code_highlight_bg: rgb(80, 80, 32),
