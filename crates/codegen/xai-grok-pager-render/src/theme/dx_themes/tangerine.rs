//! DX theme: "Tangerine" — auto-generated from dx-tui themes.json.
...
mod palette {
    use super::*;
    pub const BG: Color = rgb(59, 62, 0);
    pub const BG_DARK: Color = rgb(55, 58, 0);
    pub const BG_STORM: Color = rgb(59, 62, 0);
    pub const BG_HIGHLIGHT: Color = rgb(75, 78, 16);
    ...
    pub const ACCENT: Color = rgb(75, 80, 89);
    pub const ACCENT_DIM: Color = rgb(45, 48, 53);
    pub const GREEN: Color = rgb(114, 130, 70);
    pub const RED: Color = rgb(135, 27, 30);
    pub const RED1: Color = rgb($[Math]::Min(255, 194), $[Math]::Min(255, 143), $[Math]::Min(255, 140));
    pub const YELLOW: Color = rgb(105, 80, 44);
    pub const CYAN: Color = rgb(129, 120, 134);
    pub const BLUE: Color = rgb(38, 40, 119);
    pub const MAGENTA: Color = rgb(115, 40, 129);
    pub const PURPLE: Color = rgb(95, 27, 109);
    pub const ORANGE: Color = rgb(120, 50, 30);
    pub const RED_DARK: Color = rgb(177, 14, 20);
    pub const GREEN_DARK: Color = rgb(6, 196, 6);
}
use palette::*;
...
impl Theme {
    pub const fn tangerine() -> Self {
        Self {
            ...
            code_fg: FG,
            code_border: COMMENT,
            code_highlight_bg: rgb(91, 94, 32),
