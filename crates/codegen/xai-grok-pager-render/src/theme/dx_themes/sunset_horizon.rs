//! DX theme: "Sunset Horizon" — auto-generated from dx-tui themes.json.
...
mod palette {
    use super::*;
    pub const BG: Color = rgb(64, 61, 0);
    pub const BG_DARK: Color = rgb(60, 57, 0);
    pub const BG_STORM: Color = rgb(64, 61, 0);
    pub const BG_HIGHLIGHT: Color = rgb(80, 77, 16);
    pub const FG: Color = rgb(240, 237, 0);
    pub const FG_DARK: Color = rgb(192, 190, 0);
    pub const FG_GUTTER: Color = rgb(80, 79, 0);
    pub const COMMENT: Color = rgb(120, 118, 0);
    pub const DARK3: Color = rgb(96, 95, 0);
    pub const DARK5: Color = rgb(144, 142, 0);
    pub const ACCENT: Color = rgb(225, 202, 189);
    pub const ACCENT_DIM: Color = rgb(135, 121, 113);
    pub const GREEN: Color = rgb(212, 252, 131);
    pub const RED: Color = rgb(255, 67, 63);
    pub const RED1: Color = rgb($[Math]::Min(255, 185), $[Math]::Min(255, 134), $[Math]::Min(255, 134));
    pub const YELLOW: Color = rgb(255, 202, 94);
    pub const CYAN: Color = rgb(229, 242, 255);
    pub const BLUE: Color = rgb(112, 101, 219);
    pub const MAGENTA: Color = rgb(255, 101, 229);
    pub const PURPLE: Color = rgb(245, 67, 209);
    pub const ORANGE: Color = rgb(242, 111, 63);
    pub const RED_DARK: Color = rgb(192, 14, 20);
    pub const GREEN_DARK: Color = rgb(6, 193, 6);
}
use palette::*;
...
impl Theme {
    pub const fn sunset_horizon() -> Self {
        Self {
            ...
            code_fg: FG,
            code_border: COMMENT,
            code_highlight_bg: rgb(96, 93, 32),
