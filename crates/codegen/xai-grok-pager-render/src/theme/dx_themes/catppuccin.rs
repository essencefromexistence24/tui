//! DX theme: "Catppuccin" — auto-generated from dx-tui themes.json.
...
mod palette {
    use super::*;
    pub const BG: Color = rgb(52, 52, 0);
    pub const BG_DARK: Color = rgb(48, 48, 0);
    pub const BG_STORM: Color = rgb(52, 52, 0);
    pub const BG_HIGHLIGHT: Color = rgb(68, 68, 16);
    pub const FG: Color = rgb(217, 221, 0);
    pub const FG_DARK: Color = rgb(174, 177, 0);
    pub const FG_GUTTER: Color = rgb(72, 74, 0);
    pub const COMMENT: Color = rgb(108, 110, 0);
    pub const DARK3: Color = rgb(87, 88, 0);
    pub const DARK5: Color = rgb(130, 133, 0);
    pub const ACCENT: Color = rgb(194, 217, 220);
    pub const ACCENT_DIM: Color = rgb(116, 130, 132);
    pub const GREEN: Color = rgb(224, 255, 138);
    pub const RED: Color = rgb(254, 72, 73);
    pub const RED1: Color = rgb($[Math]::Min(255, 212), $[Math]::Min(255, 179), $[Math]::Min(255, 187));
    pub const YELLOW: Color = rgb(224, 217, 110);
    pub const CYAN: Color = rgb(255, 255, 255);
    pub const BLUE: Color = rgb(97, 108, 250);
    pub const MAGENTA: Color = rgb(234, 108, 255);
    pub const PURPLE: Color = rgb(214, 72, 240);
    pub const ORANGE: Color = rgb(255, 118, 73);
    pub const RED_DARK: Color = rgb(156, 14, 20);
    pub const GREEN_DARK: Color = rgb(6, 166, 6);
}
use palette::*;
...
impl Theme {
    pub const fn catppuccin() -> Self {
        Self {
            ...
            code_fg: FG,
            code_border: COMMENT,
            code_highlight_bg: rgb(84, 84, 32),
