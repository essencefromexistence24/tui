//! DX theme: "Graphite" — auto-generated from dx-tui themes.json.
...
mod palette {
    ...
    pub const FG: Color = rgb(223, 224, 0);
    pub const FG_DARK: Color = rgb(178, 179, 0);
    pub const FG_GUTTER: Color = rgb(74, 75, 0);
    pub const COMMENT: Color = rgb(112, 112, 0);
    pub const DARK3: Color = rgb(89, 90, 0);
    pub const DARK5: Color = rgb(134, 134, 0);
    ...
    pub const RED1: Color = rgb($[Math]::Min(255, 189), $[Math]::Min(255, 151), $[Math]::Min(255, 151));
