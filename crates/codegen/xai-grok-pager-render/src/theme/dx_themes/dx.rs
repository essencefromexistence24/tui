//! DX theme: "DX" — auto-generated from dx-tui themes.json.
...
mod palette {
    ...
    pub const ACCENT: Color = rgb(0, 255, 42);
    pub const ACCENT_DIM: Color = rgb(0, 153, 25);
    pub const GREEN: Color = rgb(254, 255, 158);
    pub const RED: Color = rgb(60, 85, 14);
    pub const RED1: Color = rgb($[Math]::Min(255, 203), $[Math]::Min(255, 154), $[Math]::Min(255, 151));
    pub const YELLOW: Color = rgb(30, 255, 21);
    pub const CYAN: Color = rgb(82, 255, 63);
    pub const BLUE: Color = rgb(0, 128, 72);
    pub const MAGENTA: Color = rgb(40, 128, 82);
    pub const PURPLE: Color = rgb(20, 85, 62);
    pub const ORANGE: Color = rgb(255, 138, 14);
