//! DX theme: "Perpetuity" — auto-generated from dx-tui themes.json.
...
mod palette {
    ...
    pub const FG: Color = rgb(182, 220, 0);
    pub const FG_DARK: Color = rgb(146, 176, 0);
    pub const FG_GUTTER: Color = rgb(61, 73, 0);
    pub const COMMENT: Color = rgb(91, 110, 0);
    pub const DARK3: Color = rgb(73, 88, 0);
    pub const DARK5: Color = rgb(109, 132, 0);
    pub const ACCENT: Color = rgb(78, 92, 95);
    pub const ACCENT_DIM: Color = rgb(47, 55, 57);
    pub const GREEN: Color = rgb(124, 142, 76);
    pub const RED: Color = rgb(138, 31, 32);
    pub const RED1: Color = rgb($[Math]::Min(255, 188), $[Math]::Min(255, 137), $[Math]::Min(255, 134));
    pub const YELLOW: Color = rgb(108, 92, 48);
    pub const CYAN: Color = rgb(135, 132, 142);
    pub const BLUE: Color = rgb(39, 46, 125);
    pub const MAGENTA: Color = rgb(118, 46, 135);
    pub const PURPLE: Color = rgb(98, 31, 115);
    pub const ORANGE: Color = rgb(132, 56, 32);
