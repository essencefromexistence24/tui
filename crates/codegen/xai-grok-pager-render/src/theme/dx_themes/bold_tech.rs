//! DX theme: "Bold Tech" — auto-generated from dx-tui themes.json.
...
mod palette {
    ...
    pub const ACCENT: Color = rgb(92, 109, 144);
    pub const ACCENT_DIM: Color = rgb(55, 65, 86);
    pub const GREEN: Color = rgb(137, 159, 84);
    pub const RED: Color = rgb(152, 36, 48);
    pub const RED1: Color = rgb($[Math]::Min(255, 194), $[Math]::Min(255, 143), $[Math]::Min(255, 140));
    pub const YELLOW: Color = rgb(122, 109, 72);
    pub const CYAN: Color = rgb(184, 149, 216);
    pub const BLUE: Color = rgb(46, 54, 174);
    pub const MAGENTA: Color = rgb(132, 54, 184);
    pub const PURPLE: Color = rgb(112, 36, 164);
    pub const ORANGE: Color = rgb(149, 64, 48);
