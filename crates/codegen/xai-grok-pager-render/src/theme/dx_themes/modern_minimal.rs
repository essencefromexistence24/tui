//! DX theme: "Modern Minimal" — auto-generated from dx-tui themes.json.
...
mod palette {
    ...
    pub const ACCENT: Color = rgb(74, 91, 112);
    pub const ACCENT_DIM: Color = rgb(44, 55, 67);
    pub const GREEN: Color = rgb(123, 141, 76);
    pub const RED: Color = rgb(134, 30, 37);
    pub const RED1: Color = rgb($[Math]::Min(255, 194), $[Math]::Min(255, 143), $[Math]::Min(255, 140));
    pub const YELLOW: Color = rgb(104, 91, 56);
    pub const CYAN: Color = rgb(152, 131, 168);
    pub const BLUE: Color = rgb(37, 46, 142);
    pub const MAGENTA: Color = rgb(114, 46, 152);
    pub const PURPLE: Color = rgb(94, 30, 132);
    pub const ORANGE: Color = rgb(131, 56, 37);
