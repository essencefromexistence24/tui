//! DX theme: "Mocha Mousse" — auto-generated from dx-tui themes.json.
...
mod palette {
    ...
    pub const FG: Color = rgb(241, 241, 0);
    pub const FG_DARK: Color = rgb(193, 193, 0);
    pub const FG_GUTTER: Color = rgb(80, 80, 0);
    pub const COMMENT: Color = rgb(120, 120, 0);
    pub const DARK3: Color = rgb(96, 96, 0);
    pub const DARK5: Color = rgb(145, 145, 0);
    pub const ACCENT: Color = rgb(189, 184, 177);
    pub const ACCENT_DIM: Color = rgb(113, 110, 106);
    pub const GREEN: Color = rgb(197, 234, 122);
    pub const RED: Color = rgb(249, 61, 59);
    pub const RED1: Color = rgb($[Math]::Min(255, 196), $[Math]::Min(255, 160), $[Math]::Min(255, 160));
    pub const YELLOW: Color = rgb(219, 184, 88);
    pub const CYAN: Color = rgb(217, 224, 255);
    pub const BLUE: Color = rgb(94, 92, 207);
    pub const MAGENTA: Color = rgb(229, 92, 217);
    pub const PURPLE: Color = rgb(209, 61, 197);
    pub const ORANGE: Color = rgb(224, 102, 59);
