//! DX theme: "Vercel" — auto-generated from dx-tui themes.json.
...
mod palette {
    ...
    pub const ACCENT: Color = rgb(75, 75, 75);
    pub const ACCENT_DIM: Color = rgb(45, 45, 45);
    pub const GREEN: Color = rgb(110, 125, 68);
    pub const RED: Color = rgb(135, 25, 25);
    pub const RED1: Color = rgb($[Math]::Min(255, 206), $[Math]::Min(255, 156), $[Math]::Min(255, 155));
    pub const YELLOW: Color = rgb(105, 75, 38);
    pub const CYAN: Color = rgb(115, 115, 112);
    pub const BLUE: Color = rgb(38, 38, 105);
    pub const MAGENTA: Color = rgb(115, 38, 115);
    pub const PURPLE: Color = rgb(95, 25, 95);
    pub const ORANGE: Color = rgb(115, 48, 25);
