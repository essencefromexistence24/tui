//! DX theme: "Caffeine" — auto-generated from dx-tui themes.json.
...
mod palette {
    ...
    pub const ACCENT: Color = rgb(68, 68, 68);
    pub const ACCENT_DIM: Color = rgb(41, 41, 41);
    pub const GREEN: Color = rgb(104, 118, 64);
    pub const RED: Color = rgb(128, 23, 23);
    pub const RED1: Color = rgb($[Math]::Min(255, 187), $[Math]::Min(255, 142), $[Math]::Min(255, 135));
    pub const YELLOW: Color = rgb(98, 68, 34);
    pub const CYAN: Color = rgb(108, 108, 102);
    pub const BLUE: Color = rgb(34, 34, 98);
    pub const MAGENTA: Color = rgb(108, 34, 108);
    pub const PURPLE: Color = rgb(88, 23, 88);
    pub const ORANGE: Color = rgb(108, 44, 23);
