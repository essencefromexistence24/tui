//! DX theme: "Northern Lights" — auto-generated from dx-tui themes.json.
...
mod palette {
    ...
    pub const ACCENT: Color = rgb(145, 165, 188);
    pub const ACCENT_DIM: Color = rgb(87, 99, 113);
    pub const GREEN: Color = rgb(182, 215, 112);
    pub const RED: Color = rgb(205, 55, 63);
    pub const RED1: Color = rgb($[Math]::Min(255, 194), $[Math]::Min(255, 143), $[Math]::Min(255, 140));
    pub const YELLOW: Color = rgb(175, 165, 94);
    pub const CYAN: Color = rgb(228, 205, 255);
    pub const BLUE: Color = rgb(72, 82, 218);
    pub const MAGENTA: Color = rgb(185, 82, 228);
    pub const PURPLE: Color = rgb(165, 55, 208);
    pub const ORANGE: Color = rgb(205, 92, 63);
