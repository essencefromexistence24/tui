...
impl AgentView {
    ...
    pub fn new(session: AgentSession, scrollback: ScrollbackState) -> Self {
        ...
        let mut view = Self {
            ...
            last_mouse_pos: (0, 0),
            splash_menu_index: None,
            splash_menu_rects: Vec::new(),
            splash_changelog_md: None,
            splash_pending_update: None,
            splash_suggestion_batch: 0,
            splash_suggestion_rotated_at: std::time::Instant::now(),
