...
const EMBEDDED_LOCALES: &[(&str, &str)] = &[
	("cs", include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/locales/cs.json"))),
	("de", include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/locales/de.json"))),
	("en", include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/locales/en.json"))),
	("es", include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/locales/es.json"))),
	("fr", include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/locales/fr.json"))),
	("it", include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/locales/it.json"))),
	("ja", include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/locales/ja.json"))),
	("ko", include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/locales/ko.json"))),
	("pt-BR", include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/locales/pt-BR.json"))),
	("ru", include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/locales/ru.json"))),
	("th", include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/locales/th.json"))),
	("uk", include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/locales/uk.json"))),
	("vi", include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/locales/vi.json"))),
	("zh-CN", include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/locales/zh-CN.json"))),
];
...
mod tests {
	...
	fn test_parse_all_locales() {
		for (locale, json) in EMBEDDED_LOCALES {
			...
			assert!(!parsed.is_empty(), "Locale {} should have translations", locale);
		}
	}
