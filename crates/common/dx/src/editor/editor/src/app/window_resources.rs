...
pub struct WindowResources {
	...
	/// Tokio runtime handle for async I/O tasks (LSP, file watchers, git, etc.).
	/// Shared from the embedding runtime. `None` means the editor was
	/// constructed without async support (rare).
