...
//!
//! ```
//! use dx::input_history::InputHistory;
//!
...
impl InputHistory {
	...
	pub fn with_capacity(max_size: usize) -> Self {
		...
		Self { items: Vec::new(), max_size, position: None, temp_input: None }
	}
...
/// Get the data directory for Dx editor state
/// Returns $XDG_DATA_HOME/dx or ~/.local/share/dx on Linux
