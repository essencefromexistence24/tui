...
impl PatchOp {
	...
	pub fn copy(offset: u64, len: u64) -> Self {
		PatchOp::Copy { copy: CopyRange { off: offset, len } }
	}

	/// Create an insert operation
	pub fn insert(data: &[u8]) -> Self {
		PatchOp::Insert { insert: InsertData { data: encode_base64(data) } }
	}
}
...
mod tests {
	...
	fn test_patch_params() {
		let ops = vec![PatchOp::copy(0, 100), PatchOp::insert(b"new content"), PatchOp::copy(200, 300)];
