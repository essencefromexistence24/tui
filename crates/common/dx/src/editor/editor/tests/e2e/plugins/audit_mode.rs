    ...
    let _ = tracing_subscriber::fmt()
        .with_env_filter(
            EnvFilter::from_default_env()
                ...
                .add_directive("dx_plugin_runtime=debug".parse().unwrap()),
        )
        .with_test_writer()
        .try_init();
...
/// Reproduces https://github.com/anomalyco/dx/issues/1452
#[test]
...
/// Regression test for https://github.com/anomalyco/dx/issues/1962.
///
