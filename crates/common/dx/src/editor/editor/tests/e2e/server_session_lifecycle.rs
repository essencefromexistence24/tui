...
use dx::server::editor_server::{EditorServer, EditorServerConfig};
...
fn make_server_config(
    ...
    EditorServerConfig {
        ...
        workspace_trust: std::sync::Arc::new(
            services::workspace_trust::WorkspaceTrust::permissive(),
        ),
        env_provider: std::sync::Arc::new(services::env_provider::EnvProvider::inactive()),
...
/// `dx -a session file.txt`, server restores workspace, then opens file.txt.
#[test]
