...
/// bottleneck. Run with: RUST_LOG=info cargo test -p dx-editor --test e2e_tests
...
fn test_search_large_file_tick_performance() {
    ...
    for i in 0..3 {
        ...
        let _ = app::editor_tick(harness.editor_mut(), || Ok(()));
...
/// Regression test for https://github.com/anomalyco/dx/issues/1466
#[test]
