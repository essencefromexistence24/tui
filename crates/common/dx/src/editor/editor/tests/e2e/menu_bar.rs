...
fn test_alt_h_opens_help_menu() {
    ...
    harness.assert_screen_contains("Show Dx Manual");
}
...
fn test_mouse_click_menu_item_executes_action() {
    ...
    // Click on "Show Dx Manual" item - it should be the first item
    ...
    harness.assert_screen_not_contains("Show Dx Manual");
