...
//!
//!   * `crates/dx-editor/src/app/lsp_requests.rs::handle_completion_response`
//!     ("Store/extend original items for type-to-filter …")
//!   * `crates/dx-editor/src/app/render.rs::hide_popup` — the close path
//!     that doesn't touch `completion_items`.
//!   * `crates/dx-editor/src/app/popup_actions.rs::handle_popup_cancel`
