...
impl BlogShowcase {
    ...
    pub fn new(name: &str, title: &str, description: &str) -> Self {
        ...
        // CARGO_MANIFEST_DIR points to crates/dx-editor/, so go up two levels
...
<!-- Generated by: cargo test --package dx-editor --test e2e_tests blog_showcase_{name} -- --ignored -->
